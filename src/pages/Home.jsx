...
import SteamMovie from './SteamMovie';
...
const Home = () => {
    ...
    const sortmovie = filtermovie.sort((a, b) => b.rating - a.rating).slice(0, 8);
    const filtermovies = movies.filter(movie => {
        const releaseYear = parseInt(movie.releaseYear);
        return releaseYear >= 2022 && releaseYear <= 2024 && movie.genre !== 'Drama';
    });
    ...
    const RomanticMovies = movies.filter(movie => movie.genre === 'Romance').slice(0, 3);


    return (
        <div className='dark:bg-black dark:text-white md:bg-base-200'>
            <Banner />
            <SteamMovie/>
            <section className='w-11/12 mx-auto my-4'>
                <p className='text-xl font-semibold text-left'>Featured Movie</p>
                ...
                <Link to='/allmovie' className='btn bg-teal-400' >See All Movies</Link>
            </section>
            <section className="w-full px-2 sm:w-11/12 sm:mx-auto my-4">
                <div className='flex justify-between items-center'>
                    <p className="text-lg sm:text-xl font-semibold text-left my-4">Trending Movies</p>
                    <Link to='allmovie' className="font-medium my-4">See All</Link>
                </div>
                <Swiper
            ...
            <section className="w-full px-2 sm:w-11/12 sm:mx-auto my-4">
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-x-2 w-full '>
                    ...
                    <div className="flex flex-col">
                        <p className="font-medium text-sm text-center mb-2">Romantic</p>
                        <Swiper
                            modules={[Navigation, Pagination, Autoplay]}
                            direction="vertical"
                            spaceBetween={10}
